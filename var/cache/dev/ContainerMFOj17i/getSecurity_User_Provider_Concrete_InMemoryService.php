...
return $this->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('elie' => array('password' => 'elie', 'roles' => array(0 => 'ROLE_USER')), 'admin' => array('password' => 'admin', 'roles' => array(0 => 'ROLE_ADMIN'))));
